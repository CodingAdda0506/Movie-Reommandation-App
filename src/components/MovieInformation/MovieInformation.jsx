...
const MovieInformation = () => {
  ...
  return (
    <section className="flex h-auto max-w-[1660px] flex-col items-center justify-center text-white lg:h-full lg:flex-row">
      ...
      <div className="h-auto w-full px-4 pb-4 md:px-16 lg:px-5 lg:py-5">
